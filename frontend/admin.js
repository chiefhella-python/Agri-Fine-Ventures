  ...
  renderNav() {
    ...
    nav.innerHTML = `
      ...
      <div class="sidebar-user">
        <div class="user-avatar">${AFV.currentUser.imageUrl ? `<img src="${AFV.currentUser.imageUrl}" style="width:100%;height:100%;object-fit:cover;border-radius:50%">` : `<span style="color:white;font-weight:700;font-size:1.1rem">${(AFV.currentUser.name || 'A')[0].toUpperCase()}</span>`}</div>
        <div>
