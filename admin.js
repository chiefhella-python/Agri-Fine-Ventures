              ...
              <tbody>
                ${pending.map(t => `
                  <tr>
                    ...
                    <td>${t.duration}</td>
                    <td>
                      <button onclick="window.AdminDashboard.openTaskModal('${t.gh.id}', '${t.id}')" style="padding:4px 8px;background:var(--blue-water);color:white;border:none;border-radius:4px;cursor:pointer;font-size:0.7rem">🖊️ Edit</button>
